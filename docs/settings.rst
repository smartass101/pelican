...
`WRITE_ONLY_SELECTED` (``[]``)                                                   If this list is not empty, only output files with their paths
                                                                                 in this list are written, see :ref:`writing_only_selected_content`.
===============================================================================  =====================================================================
...
`WRITE_ONLY_SELECTED` list and only those files will be written. This
list can be also specified on the command-line using the
``--write-only-selected`` option which accepts a comma separated list
